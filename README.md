...
**cv_huggingface_htmlout.ipynb** generates classification output into the html file - classification.html and opens it in the browser. Folder 'images' has to be at the same folder with cv_huggingface_htmlout.ipynb file. 
